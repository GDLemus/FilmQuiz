...
public class UpdateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("FilmQuiz Data").child(key);
        ...
        updateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (uri != null) {
                    saveData();
                    Intent intent = new Intent(UpdateActivity.this, MakeQuiz.class);
        ...
        storageReference = FirebaseStorage.getInstance().getReference().child("Android Images").child(UUID.randomUUID().toString()); // Utiliza UUID para generar un ID único
                ...
                uriTask.addOnCompleteListener(new OnCompleteListener<Uri>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                        if (task.isSuccessful()) {
                            ...
                            dialog.dismiss();
                            Toast.makeText(UpdateActivity.this, "Failed to retrieve image URL", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
